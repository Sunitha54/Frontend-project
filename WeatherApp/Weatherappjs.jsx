    ...
    try {
     ...
     if (response.ok) {
      setWeatherData(data);
       ...
       setError("oops!! This location is not found");
         setWeatherData(null);
       }
    } catch (error) {
  ...
  const getWeatherIconUrl = (main) => {
    switch (main) {
      ...
      case "Rain":
        ...
        case "Mist":
          return "/sun.png"; // Path to your rainy weather icon
      case "Snow":
        return "/tornado.png"; // Path to your snowy weather icon
      case "Clouds":
        return "/rain_with_cloud.png"; // Path to your haze weather icon
        case "Haze":
          return "/sun.png";
